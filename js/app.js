...
const showProducts = (products) => {
  ...
  for (const product of allProducts) {
    ...
    <div class="single-product">
      ...
      <button id="details-btn" onclick="loadDetails(${product.id})" class="btn btn-danger">Details</button>
    </div>`;
...
const updatePrice = (id, value) => {
  ...
  // Here we will show result in two decimal number using toFixed() function
